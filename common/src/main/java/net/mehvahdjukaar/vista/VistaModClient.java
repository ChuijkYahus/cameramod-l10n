...
import net.mehvahdjukaar.vista.client.ui.TvShowcaseWidget;
import net.mehvahdjukaar.vista.client.ui.ViewFinderScreen;
import net.mehvahdjukaar.vista.client.ui.VistaWelcomeScreen;
import net.mehvahdjukaar.vista.client.ui.picture_tape.MapTapeEntryRenderer;
import net.mehvahdjukaar.vista.client.ui.picture_tape.PictureTapeScreen;
...
public class VistaModClient {
    ...
    public static final ResourceLocation AUDIO_ONLY_SCREEN = VistaMod.res("audio_only");
